...
class LineLogin
{
    ...
    #### change your id
    private const CLIENT_ID = '2000450451';
    private const CLIENT_SECRET = '9a92402eca8f1138dca2ea4c7200c676';
    private const REDIRECT_URL = 'https://www.piyawat-projects-test.com/line/callback.php';
    ...
    // function getLinkPushMessage($user_id)
    // {
    //     'Login_line\'
    //     return $link;
    // }
    ...
    public function pushMessage($msg,$user_id){
